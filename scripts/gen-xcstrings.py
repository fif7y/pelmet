...
T = {
    ...
    "Get beta releases": dict(de="Beta-Versionen erhalten", fr="Recevoir les versions bêta", es="Recibir versiones beta", it="Ricevi le versioni beta", pt="Receber versões beta", ja="ベータ版を受け取る", zh="接收测试版", ko="베타 버전 받기", ru="Получать бета-версии"),
    "Smaller updates, more often. Stable releases roll them up every week or two.": dict(de="Kleinere Updates, öfter. Stabile Versionen fassen sie alle ein bis zwei Wochen zusammen.", fr="Des mises à jour plus petites, plus souvent. Les versions stables les regroupent toutes les une à deux semaines.", es="Actualizaciones más pequeñas, más a menudo. Las versiones estables las agrupan cada una o dos semanas.", it="Aggiornamenti più piccoli, più spesso. Le versioni stabili li raccolgono ogni una o due settimane.", pt="Atualizações menores, com mais frequência. As versões estáveis as reúnem a cada uma ou duas semanas.", ja="小さなアップデートを、より頻繁に。安定版は1〜2週間ごとにまとめて配信されます。", zh="更小、更频繁的更新。稳定版每一到两周汇总发布。", ko="더 작은 업데이트를 더 자주. 안정 버전은 1~2주마다 모아서 배포합니다.", ru="Небольшие обновления, чаще. Стабильные версии собирают их раз в одну-две недели."),
