...
T = {
    ...
    "Shows while audio plays. Click to play or pause, right-click for tracks.": dict(de="Erscheint, solange Audio läuft. Klick spielt oder pausiert, Rechtsklick wechselt den Titel.", fr="Visible pendant la lecture audio. Clic pour lire ou mettre en pause, clic droit pour changer de piste.", es="Se muestra mientras suena audio. Clic para reproducir o pausar, clic derecho para las pistas.", it="Appare mentre c’è audio in riproduzione. Clic per riprodurre o mettere in pausa, clic destro per i brani.", pt="Aparece enquanto há áudio tocando. Clique para tocar ou pausar, clique direito para as faixas.", ja="音声の再生中に表示。クリックで再生/一時停止、右クリックで曲送り。", zh="播放音频时显示。点击播放或暂停，右键切换曲目。", ko="오디오 재생 중에 표시됩니다. 클릭하면 재생/일시정지, 우클릭으로 트랙 이동.", ru="Показывается во время воспроизведения. Клик — играть или пауза, правый клик — треки."),
