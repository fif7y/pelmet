...
| 51 | Clock click: delayed shading under Notification Center (beta.2) | The panel is a layer-21 window under the glass; the cover (a picture) could not follow its shade. `95d2f0e`: a gradient of the measured shade fades in/out with the panel, and lifts it back off a picture taken under it; wallpaper/appearance join the backdrop signature; NC oracle ignores desktop widgets. Measured within ~1 luminance both ways 2026-09-22 11:40. | **fixed for beta.3** — close in the beta.3 comment |
